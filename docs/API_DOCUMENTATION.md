...
**文档版本**: v2.2
**更新时间**: 2025年12月31日
**状态**: ⚠️ 手动维护部分可能滞后，请以自动扫描报告为准

本文档包含核心 API 的使用说明和分类指南。
**获取最新、最全的 API 列表，请查看自动生成的实时报告：**

- **[🔍 完整 API 扫描报告](./reports/api-scan-report.md)** (实时更新，包含所有 150+ API)
- **[🏷️ API 分类统计报告](./reports/api-classification-report.md)** (按优先级分类)
