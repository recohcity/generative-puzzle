...
> **最新体检报告** | 2025-12-23 00:41:34 | 项目版本: v1.3.63
...
#### 🏆 优秀的测试覆盖率
- **整体覆盖率**: **97.08%** (7419/7642行)
- **分支覆盖率**: **94.88%** (1224/1290分支)
- **函数覆盖率**: **98.25%** (281/286函数)
- **语句覆盖率**: **97.08%** (7419/7642语句)
...
| 指标 | 覆盖率 | 已覆盖/总数 | 等级 |
|------|--------|-------------|------|
| 语句覆盖率 | 97.1% | 7419/7642 | A |
| 分支覆盖率 | 94.9% | 1224/1290 | B+ |
| 函数覆盖率 | 98.3% | 281/286 | A+ |
| 行覆盖率 | 97.1% | 7419/7642 | A |
...
*报告生成时间: 2025-12-23 00:41:34 | 项目版本: v1.3.63 | 下次体检建议: 2026-01-22*