...
> **最新体检报告** | 2025-12-23 20:47:42 | 项目版本: v1.3.65
...
- **🚀 性能卓越**: E2E加载时间1308ms，形状生成55ms
- **🧪 测试优秀**: 97.51%覆盖率，A级别标准
...
#### 🏆 优秀的测试覆盖率
- **整体覆盖率**: **97.51%** (7491/7682行)
- **分支覆盖率**: **95.64%** (1253/1310分支)
- **函数覆盖率**: **98.25%** (281/286函数)
- **语句覆盖率**: **97.51%** (7491/7682语句)
...
| 指标 | 覆盖率 | 已覆盖/总数 | 等级 |
|------|--------|-------------|------|
| 语句覆盖率 | 97.5% | 7491/7682 | A |
| 分支覆盖率 | 95.6% | 1253/1310 | A |
| 函数覆盖率 | 98.3% | 281/286 | A+ |
| 行覆盖率 | 97.5% | 7491/7682 | A |
...
*报告生成时间: 2025-12-23 20:47:42 | 项目版本: v1.3.65 | 下次体检建议: 2026-01-22*