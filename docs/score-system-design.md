...
```typescript
// 基于旋转效率的分级评分
const calculateRotationScoreByEfficiency = (efficiency: number): number => {
...
|---------|------|------|------|
| 100% | 完美 | +200分 | 完美旋转 |
| 80-99% | 接近完美 | +100分 | 接近完美 |
| 60-79% | 旋转有点多 | +50分 | 旋转有点多 |
| 40-59% | 旋转太多了 | -50分 | 旋转太多了 |
| 20-39% | 请减少旋转 | -100分 | 请减少旋转 |
| 0-19% | 看清楚再旋转 | -200分 | 看清楚再旋转 |
