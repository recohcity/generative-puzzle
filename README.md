...
[![Version](https://img.shields.io/badge/version-1.4.7-orange.svg)]()
...
- **UI / UX 视觉升级**: 最新的 **v1.4.7** 版本完成了 **安卓深层系统适配**，包括 CSS/运行时双重字号锁死对抗大字体溢出，以及废除独立 IdentityChip 统一集成至顶栏按钮，配合 `env(safe-area-inset-bottom)` 达成了极致的移动端垂直空间与交互稳定性。
