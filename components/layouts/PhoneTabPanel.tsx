    ...
    >
      ...
      <div style={{ paddingLeft: CONTENT_HORIZONTAL_PADDING, paddingRight: CONTENT_HORIZONTAL_PADDING, width: '100%', marginTop: (isGameCompleted || showLeaderboard) ? 0 : 0, flex: 1, overflow: 'hidden' }} className="no-scrollbar">
        {showLeaderboard && user ? (
          ...
          /* 游戏结算界面 - 统一横竖屏：单行全量摘要 */
          <div className="flex flex-col justify-start w-full pt-1 flex-1 min-h-0" style={{ height: isLandscape ? 'auto' : TAB_BUTTON_HEIGHT + (isUltraSmall ? 128 : 140) - 2 }}>
          ...
          <div className="flex flex-col justify-start w-full pt-2 flex-1 min-h-0" style={{ height: isLandscape ? 'auto' : TAB_BUTTON_HEIGHT + (isUltraSmall ? 128 : 140) - 2 }}>
